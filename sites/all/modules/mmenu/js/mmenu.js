  ...
  Drupal.behaviors.mmenu = {
    attach: function (context, settings) {
      ...
      for (var key in Drupal.mmenu.settings) {
        ...
        console.log('debug', mmenu.options);
        console.log('debug', mmenu.configurations);
